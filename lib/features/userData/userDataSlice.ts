...
export type LevelStateData = {
  level: number,
  stateTimeline: AlgorithmState[],
  currentStateIndex: number,
}

// Bubble Sort State Interface.
 ...
 */
export function createState(array: number[], i: number, b: number): AlgorithmState {
...
const initialAlgorithmState = createState(initialArray, 0, arrayLength)

function initLevelState(level: number, initialState: AlgorithmState): LevelStateData {
...
const initialLevelStateData = initLevelState(0, initialAlgorithmState)
